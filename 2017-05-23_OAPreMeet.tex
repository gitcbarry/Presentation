...
%\captionsetup[figure]{labelformat=empty,labelsep=none}% redefines 
...
\begin{frame}{Validation overview}
	\begin{itemize}
		\item Event rates:
		\begin{itemize}
			\item Good agreement amongst VALOR, MaCh3 and p-theta for Asimov A and Asimov B
		\end{itemize}
...
\begin{frame}{Conclusion}
	\centering
	\begin{itemize}
		\item Good agreement between VALOR and MaCh3 and p-theta in rates
                \item Diferences seen in p-theta systematic variations
